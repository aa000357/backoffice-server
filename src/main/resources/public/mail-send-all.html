                    ...
                    <div class="card-body card-block">
                        <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-3"><input class="form-control datepicker" type="text" ></div>
                            </div>
                            ...
                            <div class="card-body">
                                <button style="float:right" type="button" class="btn btn-primary btn-sm" onclick="window.location.assign('mail-send-all-preview.html', '信件發送預覽');">預覽</button>
                            </div>
                        </form>
                    </div>
